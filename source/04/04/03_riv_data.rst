...
選択した河川横断線に、地形データをマッピングします。

地形データからの断面データの抽出ダイアログ (:numref:`image_geo_riv_mapping_dialog` 参照)
が表示されます。
...
.. figure:: images/geo_riv_mapping_dialog.png
   ...
   地形データからの断面データの抽出ダイアログ

   .. note::

      iRIC 4.0 までは点群データのみマッピングが可能だけでしたが、 4.1 からラスターデータもマッピングが可能になりました。
